...
/**
 * @ClassName: SimpleURLLogin
 * @Description: URLLogin的简单实现
 * @author Lanxiaowei(736031305@qq.com)
 * @date 2015年10月30日 下午3:59:56
 *
 */
public class SimpleURLLogin extends FormLogin {
	/**登录帐号*/
	...
	public SimpleURLLogin(String userName, String password,
	...
	public SimpleURLLogin(String userName, String password, String validateCode) {
		this.userName = userName;
		this.password = password;
		this.validateCode = validateCode;
	}
	...
	public AuthInfo buildAuthInfo() {
		//若是GET请求
		if(HttpConstant.Method.GET.equalsIgnoreCase(method())) {
			URLAuthInfo urlAuthInfo = null;
			try {
				urlAuthInfo = new URLAuthInfo(userName, password, validateCode, loginUrl, usernameParamName, passwordParamName, validateCodeParamName);
