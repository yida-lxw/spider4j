 ...
 * @Description: 详情页附属页处理器默认实现
 * @author Lanxiaowei(736031305@qq.com)
 * @date 2015年10月13日 下午5:35:13
 *
 */
public abstract class SimpleAttachedPageProcessor extends SimplePageProcessor implements AttachedPageProcessor {
	public SimpleAttachedPageProcessor(PageProcessorParam pageProcessorParam) {
		super(pageProcessorParam);
		if(!(pageProcessorParam instanceof AttachedPageProcessorParam)) {
			throw new IllegalArgumentException("pageProcessorParam MUST be type of AttachedPageProcessor.");
		}
	}
	...
	public void process(Page page) {
		...
		if(null == page || (page.getPageType() != null && !page.getPageType().equals(PageType.ATTACHED_PAGE))) {
			return;
		}
