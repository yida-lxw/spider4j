...
public abstract class ImmutableBiMap<K, V> extends ImmutableMap<K, V> implements
		BiMap<K, V> {
	...
	public static final class Builder<K, V> extends ImmutableMap.Builder<K, V> {
		 ...
		 * builder generated by {@link ImmutableBiMap#builder}.
		 */
		public Builder() {
		}

		/**
		 * Associates {@code key} with {@code value} in the built bimap.
		 * Duplicate keys or values are not allowed, and will cause
		 * {@link #build} to fail.
		 */
		@Override
	...
	public static <K, V> ImmutableBiMap<K, V> copyOf(
		...
		if (map instanceof ImmutableBiMap) {
			...
			// forward map is a view, don't make a copy of the non-view delegate
			// map
	 ...
	 * 
	 * Since the bimap is immutable, ImmutableBiMap doesn't require special
	 * logic for keeping the bimap and its inverse in sync during serialization,
	 * the way AbstractBiMap does.
	 */
