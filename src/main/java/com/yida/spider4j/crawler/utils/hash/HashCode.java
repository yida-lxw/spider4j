...
import com.yida.spider4j.crawler.utils.collection.primitives.UnsignedInts;
...
public abstract class HashCode {
	...
	public final int writeBytesTo(byte[] dest, int offset, int maxLength) {
		...
		Preconditions.checkPositionIndexes(offset, offset + maxLength,
				dest.length);
		// TODO(user): Consider avoiding the array creation in asBytes() by
		// stepping through
	...
	public final boolean equals(Object object) {
		if (object instanceof HashCode) {
			...
			// Undocumented: this is a non-short-circuiting equals(), in case
