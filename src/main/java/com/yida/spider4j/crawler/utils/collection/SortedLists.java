...
final class SortedLists {
  ...
  enum Relation {
     ...
     */
    abstract <E> int exactMatchFound(List<? extends E> list, E e,
        int lower, int index, int upper, Comparator<? super E> comparator,
        boolean worryAboutDuplicates);
     ...
     */
    abstract <E> int exactMatchNotFound(List<? extends E> list, E e,
        int higherIndex, Comparator<? super E> comparator);
  }
   ...
   */
  static <E> int binarySearch(List<? extends E> list, E e,
