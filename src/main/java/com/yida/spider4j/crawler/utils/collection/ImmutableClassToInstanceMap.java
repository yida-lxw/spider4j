...
public final class ImmutableClassToInstanceMap<B> extends
	...
	public static final class Builder<B> {
		private final ImmutableMap.Builder<Class<? extends B>, B> mapBuilder = ImmutableMap
				.builder();
		 ...
		 *             if any value is not an instance of the type specified by
		 *             its key
		 */
		public <T extends B> Builder<B> putAll(
				Map<? extends Class<? extends T>, ? extends T> map) {
			for (Entry<? extends Class<? extends T>, ? extends T> entry : map
					.entrySet()) {
	 ...
	 *             if any key or value in {@code map} is null
	 * @throws ClassCastException
	 *             if any value is not an instance of the type specified by its
	 *             key
	 */
