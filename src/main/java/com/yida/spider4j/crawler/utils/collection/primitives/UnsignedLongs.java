...
public final class UnsignedLongs {
	 ...
	 * 
	 * @param array
	 *            a <i>nonempty</i> array of unsigned {@code long} values
	 ...
	 * @param array
	 *            an array of unsigned {@code long} values, possibly empty
	 */
	...
	/**
	 * Returns a comparator that compares two arrays of unsigned {@code long}
	 * values lexicographically. That is, it compares, using
	 ...
	 *             if {@code s} is null (in contrast to
	...
	public static long decode(String stringValue) {
		...
		try {
			...
			NumberFormatException decodeException = new NumberFormatException(
