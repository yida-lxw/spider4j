...
import com.yida.spider4j.crawler.utils.collection.primitives.UnsignedBytes;
 ...
 */
public final class Murmur3_128HashFunction extends
		AbstractStreamingHashFunction implements Serializable {
	// TODO(user): when the shortcuts are implemented, update
	...
	private static final class Murmur3_128Hasher extends
		...
		protected void processRemaining(ByteBuffer bb) {
			...
			case 9:
				k2 ^= (long) UnsignedBytes.toInt(bb.get(8)); // fall through
			case 8:
				k1 ^= bb.getLong();
				break;
			case 7:
		...
		public HashCode makeHash() {
			...
			return HashCode.fromBytesNoCopy(ByteBuffer
					.wrap(new byte[CHUNK_SIZE]).order(ByteOrder.LITTLE_ENDIAN)
