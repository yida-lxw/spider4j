...
public final class BigIntegerMath {
  ...
  public static int log2(BigInteger x, RoundingMode mode) {
    ...
    switch (mode) {
      case UNNECESSARY:
    	  MathPreconditions.checkRoundingUnnecessary(isPowerOfTwo(x)); // fall through
      case DOWN:
      case FLOOR:
        return logFloor;
  ...
  public static BigInteger sqrt(BigInteger x, RoundingMode mode) {
    ...
    switch (mode) {
      case UNNECESSARY:
    	  MathPreconditions.checkRoundingUnnecessary(sqrtFloor.pow(2).equals(x)); // fall through
      case FLOOR:
      case DOWN:
        return sqrtFloor;
      case CEILING:
  ...
  public static BigInteger factorial(int n) {
    ...
    int approxSize = IntMath.divide(n * IntMath.log2(n, RoundingMode.CEILING), Long.SIZE, RoundingMode.CEILING);
