...
import com.yida.spider4j.crawler.utils.collection.anno.CheckReturnValue;
...
public final class UnsignedLong extends Number implements
		Comparable<UnsignedLong>, Serializable {
	...
	/**
	 * Returns an {@code UnsignedLong} corresponding to a given bit
	 * representation. The argument is interpreted as an unsigned 64-bit value.
	 * Specifically, the sign bit of {@code bits} is interpreted as a normal
	 * bit, and all other bits are treated as usual.
	 * 
	 * <p>
	...
	/**
	 * Returns an {@code UnsignedLong} representing the same value as the
	 * specified {@code long}.
	 * 
	...
	public UnsignedLong dividedBy(UnsignedLong val) {
		return fromLongBits(UnsignedLongs.divide(value,
	...
	public UnsignedLong mod(UnsignedLong val) {
		return fromLongBits(UnsignedLongs.remainder(value,
				Preconditions.checkNotNull(val).value));
	}
	 ...
	 * an inverse operation to {@link #fromLongBits}.
	 * 
	 * <p>
