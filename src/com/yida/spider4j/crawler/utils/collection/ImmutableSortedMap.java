...
public class ImmutableSortedMap<K, V>
  ...
  public ImmutableSortedMap<K, V> headMap(K toKey) {
    int newToIndex = findSubmapIndex(Preconditions.checkNotNull(toKey));
  ...
  public ImmutableSortedMap<K, V> subMap(K fromKey, K toKey) {
    ...
    Preconditions.checkArgument(comparator.compare(fromKey, toKey) <= 0);
  ...
  public ImmutableSortedMap<K, V> tailMap(K fromKey) {
    int newFromIndex = findSubmapIndex(Preconditions.checkNotNull(fromKey));
